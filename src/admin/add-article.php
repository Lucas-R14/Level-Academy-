...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['article_submit'])) {    
    try {
        ...
        // Create article
        $article_id = $articleController->create(
        ...
        <form class="main-form" method="POST">
            ...
            <div class="form-group">
                ...
                <div class="content-editor" id="content-editor">
                    ...
                    <div id="editor-content" contenteditable="true" class="editor-content" placeholder="Enter article content...">
                        <?php if (isset($_POST['content'])): ?>
                            <?php echo htmlspecialchars($_POST['content']); ?>
                        <?php endif; ?>
                    </div>
                    <input type="hidden" id="content-value" name="content" value="">
                </div>
            </div>

            <div class="form-group">
                <button type="submit" class="btn btn-primary" name="article_submit">Save Article</button>
            </div>
        </form>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Obter o ID do artigo (se disponível)
    const articleId = document.getElementById('title')?.value || '';
