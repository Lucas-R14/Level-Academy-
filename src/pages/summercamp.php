...
<head>
    ...
    <title>Inside / Out Summer Camp - Level Academy</title>
...
<body>
    <div class="tournaments-hero">
        <h1 class="tournaments-title">Inside / Out Summer Camp</h1>
        <p class="tournaments-subtitle">Based on the 3 pillars of Education, Competition and Values, this bootcamp is designed to harness a student's passion for video games to impart a responsible, professional, athletic, and goal-oriented mindset.</p>
    </div>
                ...
                <div class="tournament-content-wrap">
                    ...
                    <div class="camp-section">
                        ...
                        <ul>
                            ...
                            <li>Gained valuable insights into the game development process, with hands-on experience creating and refining their own game projects</li>
                            <li>Developed an appreciation for the importance of physical activity and its impact on their overall well-being and gaming performance</li>
                            <li>Fostered teamwork, communication, and leadership skills through various group activities and projects</li>
